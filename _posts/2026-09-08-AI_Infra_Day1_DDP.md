...
category: notes
permalink: /posts/AI_Infra_Day1_DDP/
---
# 第一版：手动DDP
...
- 参考代码：[train manual](https://github.com/zjutoe/ml-lab/blob/master/experiments/ddp_minimal/train_manual_sync.py)
# 第二版：自动DDP
...
- 参考代码：[train DDP](https://github.com/zjutoe/ml-lab/blob/master/experiments/ddp_minimal/train_ddp.py)
# 数据同步的不同方式
